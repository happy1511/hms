...
const toBillingRowFromOpd = (item: OPDType): BillingRow => {
  const paidAmount = item.invoice.transactions.reduce((sum, t) => sum + t.amount, 0);
  const discount =
...
const FinanceBilling = () => {
  ...
  const columns: ColumnDefWithClass<BillingRow>[] = [
    {
      accessorKey: "srn",
      header: ({ column }) => <SortableHeader<BillingRow> label="ID" column={column} />,
    ...
    },
    {
      ...
      header: ({ column }) => <SortableHeader<BillingRow> label="Type" column={column} />,
      headerClassName: "min-w-20 max-w-30",
      cellClassName: "min-w-20 max-w-30",
    },
    {
      accessorKey: "billNumber",
      header: ({ column }) => <SortableHeader<BillingRow> label="Bill No." column={column} />,
    ...
    },
    {
      ...
      header: ({ column }) => <SortableHeader<BillingRow> label="Patient" column={column} />,
      headerClassName: "min-w-40",
      cellClassName: "min-w-40",
    },
    {
      accessorKey: "createdAt",
      header: ({ column }) => <SortableHeader<BillingRow> label="Date/Time" column={column} />,
    ...
    {
      accessorKey: "total",
      header: ({ column }) => <SortableHeader<BillingRow> label="Total" column={column} />,
    ...
    },
    {
      ...
      header: ({ column }) => <SortableHeader<BillingRow> label="Discount" column={column} />,
    ...
    },
    {
      ...
      header: ({ column }) => <SortableHeader<BillingRow> label="Final" column={column} />,
    ...
    },
    {
      ...
      header: ({ column }) => <SortableHeader<BillingRow> label="Paid" column={column} />,
    ...
    },
    {
      ...
      header: ({ column }) => <SortableHeader<BillingRow> label="Due" column={column} />,
      cell: ({ row }) => `₹ ${(row.original.finalAmount - row.original.paidAmount).toFixed(2)}`,
      headerClassName: "min-w-24 max-w-30",
      cellClassName: "min-w-24 max-w-30",
    },
    {
      ...
      cell: ({ row }) => {
        ...
        if (canPrint) {
          items.push(
            {
              label: "Print Invoice",
              onClick: () => window.open(`/invoice/print/${row.original.invoiceId}`, "_blank"),
            },
            {

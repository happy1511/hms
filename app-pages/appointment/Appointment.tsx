...
import { useAppointmentsList } from "@/hooks/query/appointment";
  ...
  const columns: ColumnDefWithClass<AppointmentWithPatient>[] = [
    {
      ...
      header: ({ column }) => {
        return (
          <SortableHeader<AppointmentWithPatient> label="ID" column={column} />
        );
      },
    ...
    },
    {
      ...
      header: ({ column }) => {
        return (
          <SortableHeader<AppointmentWithPatient>
            label="Patient Name"
            column={column}
          />
        );
    ...
    //   header: () => <p>Action</p>,
    //   cell: ({ row }) => (
    //     <Actions<AppointmentWithPatient>
    //       data={row.original}
